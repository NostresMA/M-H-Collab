      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        duration: 0.8
          ...
          delay: 0.3
            ...
            <a href="https://widget.easyweek.com.ua/love-element/team/152718/264489" target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center px-10 py-5 bg-navy-500 text-white rounded-full font-medium text-lg transition-all duration-300 hover:bg-navy-400 hover:shadow-2xl hover:shadow-navy-500/25">
