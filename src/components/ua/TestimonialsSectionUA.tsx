...
{
  quote:
  'Раніше автоматизація здавалася мені чимось складним і холодним. Але рішення на Lovable дозволило створити зручний кабінет для моїх клієнтів за лічені дні. Це не просто економія часу — це новий рівень турботи про людину.',
  name: 'Д-р Елена Васкес',
  role: 'Приватна практика',
  initials: 'ЕВ'
},
{
  quote:
