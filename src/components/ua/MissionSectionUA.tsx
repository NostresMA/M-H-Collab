...
export function MissionSectionUA() {
  const features = [{
    ...
    description: 'Ми віримо, що технології повинні адаптуватися до потреб людини, а не навпаки. Кожен рядок коду написаний зі співчуттям.'
  }, {
    icon: Shield,
    title: 'Довіра та Приватність',
    description: 'Створення безпечних цифрових просторів, де користувачі почуваються захищеними, досліджуючи своє ментальне благополуччя.'
  }, {
    icon: Zap,
    title: 'Інновації',
    description: 'Використання передового ШІ та науки про дані для надання персоналізованої підтримки, яка масштабується для кожного.'
  }];
  return <section id="mission" className="py-24 md:py-32 relative">
