...
export function ServicesSectionUA() {
  const services = [
  {
    ...
    description:
    'Розробка кастомних вебзастосунків (кабінети клієнтів, трекери стану, платформи для навчання) за лічені дні, а не місяці.'
  },
  {
    featured: false,
    category: 'Етика',
    ...
    description:
    'Навчання команд та аудит процесів. Гарантуємо, що ваш сервіс та маркетинг не ретравматизують, а підтримують.'
  },
  {
    featured: false,
    category: 'Візуал',
    ...
    title: 'Brand Lifting',
    description:
    'Смислове та візуальне перезавантаження вашої організації. Робимо ваш бренд помітним та професійним.'
  },
  {
    featured: false,
    category: 'Стратегія',
    ...
    description:
    'Проєктуємо шлях клієнта так, щоб звернення до вашої організації приносили полегшення та результат.'
  }];
