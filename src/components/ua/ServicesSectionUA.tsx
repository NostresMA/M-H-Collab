...
export function ServicesSectionUA() {
  const services = [{
    ...
    category: 'Технології',
    icon: Rocket,
    title: 'Швидкі Web Apps (на Lovable)',
    description: 'Розробка кастомних вебзастосунків (кабінети клієнтів, трекери стану, платформи для навчання) за лічені дні, а не місяці.'
  }, {
    featured: false,
    category: 'Етика',
    icon: GraduationCap,
    title: 'Травмаінформованість',
    description: 'Навчання команд та аудит процесів. Гарантуємо, що ваш сервіс та маркетинг не ретравматизують, а підтримують.'
  }, {
    featured: false,
    category: 'Візуал',
    icon: Palette,
    title: 'Brand Lifting',
    description: 'Смислове та візуальне перезавантаження вашої організації. Робимо ваш бренд помітним та професійним.'
  }, {
    featured: false,
    category: 'Стратегія',
    icon: Compass,
    title: 'Сервіс-дизайн та консалтинг',
    description: 'Проєктуємо шлях клієнта так, щоб звернення до вашої організації приносили полегшення та результат.'
  }];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
          ...
          delay: 0.1
            ...
            Ми віримо, що технології не повинні замінювати людину — вони мають{' '}
            <span className="text-sage-400 font-bold">
              звільнити людину для людини
            </span>
            . Наша колаборація створена, щоб надати вам інструменти для етичного
            та швидкого масштабування.
          </motion.p>
        </div>
