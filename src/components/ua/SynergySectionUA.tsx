        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-0 items-stretch">
          ...
          <motion.div
            ...
            <p className="text-white/60 leading-relaxed mb-8 text-sm">
              Стратегічний технологічний партнер, що надає рішення на базі ШІ,
              системи цифрового маркетингу та масштабовані платформи, які
              забезпечують вимірюваний ріст.
            </p>
          ...
          <motion.div
            ...
            <p className="text-navy-400 leading-relaxed mb-8 text-sm">
              Ініціатива ментального здоров'я, що базується на
              травма-інформованих цінностях, клінічній експертизі та глибокій
              відданості доступній, етичній допомозі для всіх.
            </p>
