...
export function ChallengesSectionUA() {
  const challenges = [
  {
    ...
    description:
    'ШІ може здаватися бездушним. Ми інтегруємо інновації крізь фільтр травмаінформованості, роблячи сервіси людяними та безпечними.'
  },
  {
    icon: FileStack,
  ...
  },
  {
    ...
    description:
    'Дизайн у сфері Mental Health — це про безпеку. Ми оновлюємо візуальну мову вашого проєкту, щоб вона транслювала надійність та сучасність.'
  },
  {
    icon: MessageSquareWarning,
    title: 'Складно пояснити цінність вашого продукту?',
    description:
    'Ми структуруємо хаос у комунікаціях, допомагаючи чітко донести вашу місію до донорів та клієнтів.'
  }];
