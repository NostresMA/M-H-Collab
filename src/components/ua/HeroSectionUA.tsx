...
export function HeroSectionUA() {
  return <section className="relative min-h-screen flex items-center overflow-hidden pt-20 lg:pt-0">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col items-start text-left pt-10 lg:pt-0 min-w-0">
            ...
            ease: 'easeOut'
              ...
              <a href="https://widget.easyweek.com.ua/love-element/team/152718/264489" target="_blank" rel="noopener noreferrer" className="group px-6 sm:px-8 py-3 sm:py-4 bg-navy-500 text-white rounded-full font-medium text-base sm:text-lg transition-all duration-300 hover:bg-navy-400 hover:shadow-xl hover:shadow-navy-500/20 flex items-center justify-center text-center shrink-0">
          ...
          ease: 'easeOut'
            ...
            {/* Orbital Ring Paths */}
            <svg className="absolute inset-0 w-full h-full z-[5] pointer-events-none" viewBox="0 0 500 500">

              <motion.ellipse cx="250" cy="250" rx="130" ry="130" fill="none" stroke="rgba(124, 154, 130, 0.15)" strokeWidth="1" strokeDasharray="6 8" animate={{
              rotate: [0, 360]
            }} transition={{
              duration: 60,
              repeat: 999,
              ...
              <motion.ellipse cx="250" cy="250" rx="200" ry="185" fill="none" stroke="rgba(27, 42, 74, 0.08)" strokeWidth="1" strokeDasharray="4 10" animate={{
              rotate: [0, -360]
            }} transition={{
              duration: 90,
              repeat: 999,
            ...
            ease: 'easeInOut'
              ...
              ease: 'easeInOut'
                ...
                <img src="/favicon2.png" alt="MHC Logo" className="w-20 h-20 object-contain opacity-70" />
            ...
            ease: 'easeInOut'
              ...
              <div className="w-20 h-20 rounded-full glass flex items-center justify-center shadow-lg backdrop-blur-md border border-white/40 p-4 bg-white/30">
                <img src="/Love_Element_Sign_purple_soft.png" alt="Love Element" className="w-full h-full object-contain" />
            ...
            delay: 0.5
              ...
              <div className="w-24 h-24 rounded-full glass flex items-center justify-center shadow-lg backdrop-blur-md border border-white/40 p-5 bg-white/30">
                <img src="/1_2_SU_Logo_Sign_Blue.png" alt="Star&Unicorn" className="w-full h-full object-contain" />
            ...
            delay: 1.8
              ...
              <div className="w-[52px] h-[52px] rounded-full glass flex items-center justify-center shadow-md border border-white/30 bg-white/60">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                  <path d="M12 2L2 19.5H7.5L12 11.5L16.5 19.5H22L12 2Z" fill="#1A73E8" />

                  <path d="M12 11.5L7.5 19.5H16.5L12 11.5Z" fill="#E8710A" />
                  <path d="M7.5 19.5H2L12 11.5L7.5 19.5Z" fill="#1A73E8" opacity="0.7" />

                  <path d="M16.5 19.5H22L12 11.5L16.5 19.5Z" fill="#34A853" opacity="0.8" />
            ...
            delay: 3
              ...
              <div className="w-[52px] h-[52px] rounded-full glass flex items-center justify-center shadow-md border border-white/30 bg-white/60">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
                  <path d="M12 3C12 3 12.8 5.5 14.5 7.5C16.2 9.5 19 10.5 19 10.5C19 10.5 16.2 11.5 14.5 13.5C12.8 15.5 12 18 12 18C12 18 11.2 15.5 9.5 13.5C7.8 11.5 5 10.5 5 10.5C5 10.5 7.8 9.5 9.5 7.5C11.2 5.5 12 3 12 3Z" fill="#D97757" />

                  <circle cx="17.5" cy="5.5" r="2" fill="#D97757" opacity="0.6" />
