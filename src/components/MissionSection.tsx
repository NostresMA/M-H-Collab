...
export function MissionSection() {
  const features = [{
    icon: Heart,
    title: 'Empathy First',
    description: 'We believe technology should adapt to human needs, not the other way around. Every line of code is written with compassion.'
  }, {
    icon: Shield,
    title: 'Trust & Privacy',
    description: 'Creating safe digital spaces where users feel secure to explore their mental well-being without compromise.'
  }, {
    icon: Zap,
    title: 'Innovation',
    description: 'Leveraging cutting-edge AI and data science to provide personalized support that scales to reach everyone.'
  }];
