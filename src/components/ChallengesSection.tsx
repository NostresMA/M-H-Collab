...
export function ChallengesSection() {
  const challenges = [
  {
    ...
    description:
    'When routine tasks consume valuable time, the capacity for genuine human connection diminishes. We streamline the process to bring focus back to care.'
  },
  {
    icon: RefreshCw,
  ...
  },
  {
    ...
    description:
    'Translating clinical value into clear, accessible language is difficult. We bridge the gap between professional expertise and patient understanding.'
  }];
