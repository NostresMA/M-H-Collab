        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col items-start text-left pt-10 lg:pt-0">
            ...
            ease: 'easeOut'
              ...
              <a href="#contact" className="group px-8 py-4 bg-navy-500 text-white rounded-full font-medium text-lg transition-all duration-300 hover:bg-navy-400 hover:shadow-xl hover:shadow-navy-500/20 flex items-center justify-center whitespace-nowrap shrink-0">
