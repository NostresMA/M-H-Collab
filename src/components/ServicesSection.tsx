...
export function ServicesSection() {
  const services = [
  {
    ...
    description:
    'Lovable-powered client portals and digital platforms, built in days not months. Modern, responsive, and designed to scale with your practice.'
  },
  {
    featured: false,
    category: 'Ethics',
    ...
    description:
    'Comprehensive training programs that equip your team with the sensitivity and skills to deliver technology-assisted care without risking re-traumatization.'
  },
  {
    featured: false,
    category: 'Visual',
    ...
    description:
    'Strategic brand evolution that builds trust at first glance — from visual identity systems to digital presence that reflects your expertise and warmth.'
  },
  {
    featured: false,
    category: 'Strategy',
    ...
    description:
    'End-to-end service design that maps your client journey, identifies friction points, and architects solutions grounded in both data and empathy.'
  }];
