...
const trustPoints = [{
  number: '15+',
  caption: 'Years of Expertise in Marketing & Innovation',
  icon: Award,
  accentColor: 'bg-sage-400/10',
  iconColor: 'text-sage-400/30'
}, {
  number: '7',
  caption: 'Years of Service Design in Mental Health Support',
  icon: HeartPulse,
  accentColor: 'bg-warm-400/10',
  iconColor: 'text-warm-400/30'
}, {
  number: '2',
  caption: 'Founded / Managed NGOs in Our Portfolio',
  icon: Building2,
  accentColor: 'bg-navy-400/5',
  iconColor: 'text-navy-400/20'
}];
export function ImpactSection() {
  return <section id="impact" className="py-24 md:py-32 bg-cream-100 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16 md:mb-20">
          ...
          once: true
            ...
            Our Foundation of{' '}
            <span className="text-sage-400 italic">Trust</span>
          </motion.h2>
          <motion.p initial={{
          opacity: 0,
          y: 20
          ...
          delay: 0.1
            ...
            Decades of combined experience across technology, mental health, and
            social impact — the bedrock of everything we build.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
          ...
          delay: index * 0.12
              ...
              <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 ${point.accentColor} rounded-full blur-2xl pointer-events-none`} />
